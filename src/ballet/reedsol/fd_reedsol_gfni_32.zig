...
export fn fd_reedsol_private_encode_32_32(
    ...
    while (pos < shred_sz) {
        ...
        inline for (Butterfly.ifft) |b| ifft(&v, b.r0, b.r1, b.c);
        // Evaluates the polynomial at integers in [32, 64) to produce
        // 32 parity shreds.
        inline for (Butterfly.fft) |b| fft(&v, b.r0, b.r1, b.c);
...
const Butterfly = struct {
    ...
    const N = 32;
    const fft = genForwards(N, 32, 0, 0);
