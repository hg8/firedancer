...
test_hfork_vote_counting( void ) {
  ...
  fd_hfork_count_vote( hfork, &voters[0], &block_id, &bank_hash, slot, 10, 100, NULL );
  ...
  fd_hfork_count_vote( hfork, &voters[1], &block_id, &bank_hash, slot, 51, 100, NULL );
  ...
  fd_hfork_count_vote( hfork, &voters[0], &block_id, &bank_hash, slot+1, 10, 100, NULL );
  FD_TEST( bhm->stake   ==61 );
  FD_TEST( bhm->vtr_cnt ==2  );
...
test_hfork_multiple_bank_hashes( void ) {
  ...
  ulong bank_hash_cnt = 0;
  fd_hfork_count_vote( hfork, &voters[0], &block_id, &bank_hash0, slot, 1,  100, &bank_hash_cnt );
  FD_TEST( bank_hash_cnt==1 );
  fd_hfork_count_vote( hfork, &voters[1], &block_id, &bank_hash1, slot, 51, 100, &bank_hash_cnt );
  FD_TEST( bank_hash_cnt==2 );
  fd_hfork_count_vote( hfork, &voters[2], &block_id, &bank_hash2, slot, 2,  100, &bank_hash_cnt );
  FD_TEST( bank_hash_cnt==3 );
  fd_hfork_count_vote( hfork, &voters[3], &block_id, &bank_hash3, slot, 3,  100, &bank_hash_cnt );
  FD_TEST( bank_hash_cnt==4 );
...
test_hfork_eviction( void ) {
  ...
  fd_hfork_count_vote( hfork, &voters[0], &block_ids[0], &bank_hashes[0], slots[0], 10, 100, NULL );
  fd_hfork_count_vote( hfork, &voters[0], &block_ids[1], &bank_hashes[1], slots[1], 10, 100, NULL );
  fd_hfork_count_vote( hfork, &voters[0], &block_ids[2], &bank_hashes[2], slots[2], 10, 100, NULL );
  ...
  fd_hfork_count_vote( hfork, &voters[0], &block_ids[3], &bank_hashes[3], slots[3], 10, 100, NULL );
  ...
  fd_hfork_count_vote( hfork, &voters[0], &block_ids[4], &bank_hashes[4], slots[4], 10, 100, NULL );
