...
fd_tower_reconcile( fd_tower_t  *       tower,
  ...
  /* At this point our local tower is too old, and we need to replace
     it with our on-chain tower.  This mirrors the Agave logic:
     https://github.com/firedancer-io/agave/blob/master/core/src/replay_stage.rs#L3690-L3719 */

  FD_LOG_NOTICE(("reconcile: popping %lu votes from tower", fd_tower_cnt( tower )));
